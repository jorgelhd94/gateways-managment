...
const selectGenericClass = 'block w-52 text-gray-700 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm';
const selectSuccessClass = selectGenericClass + ' focus:outline-none focus:ring-primary-500 focus:border-primary-500';
const selectErrorClass = selectGenericClass + ' ring-2 ring-red-500 outline-none focus:ring-danger-500 focus:border-danger-500';
